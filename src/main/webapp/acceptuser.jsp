...
<%!
 ...
 con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/adlab4","root","Mohan2001");
  ps1 = con.prepareStatement("select count(*) from users where uname = ? and pass=?");
...
<%
 ...
 out.println("<b><i><a href=ajax_req.html><font size=6 color=blue>Click Here to Login</font></i></a></b>");
